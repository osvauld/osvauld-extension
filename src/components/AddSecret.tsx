    ...
    <div className="h-full w-full bg-[#2E3654] rounded-md p-3 pb-1 box-border">
      <div className="h-full">
        <div className=" h-4/12">
          ...
          <input
            type="text"
            className="w-full h-auto bg-[#2E3654] text-base pl-4 py-[2px] text-white border border-[#4C598B] rounded-3xl focus:outline-none"
            value={activeTab}
          />
        </div>
        <div className="h-1/6 mt-2">
          <label className="text-[#828CAE] h-1/3">Username</label>
        ...
        <div className=" h-auto mt-0 flex justify-end">
          <button
            className="bg-[#4E46DC] px-4 py-2 rounded-3xl text-white text-bold hover:bg-[#3A4468] transition ease-in cursor-pointer"
